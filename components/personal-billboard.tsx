...
export default function Billboard(){
    return(
        <div className="w-full flex flex-col gap-20 md:gap-0 md:grid grid-cols-2 bg-white rounded-2xl p-5 shadow-2xl shadow-slate-700">
              <p className="border-b-2 md:p-15 md:border-b-0 md:text-3xl text-center place-content-center">
                  ...
                  Head on over to the <Link href="#"><strong className="text-(--secondary) text-shadow-md text-shadow-black">Contact</strong></Link> page
              ...
              <div className="text-center flex flex-col">
                  ...
                  <ul className="grid grid-cols-2 gap-2 md:text-2xl">
                      <li>
                          ...
                          <strong className="text-(--primary) text-shadow-md text-shadow-black">TailwindCSS: </strong>
                          Framework for styling, themes, and layout
                          </Link>
                      </li>
                      <li>
                          <Link href="#" className="p-5 flex flex-col text-center bg-white hover:bg-gray-400/10 rounded-2xl border-b-2 size-full place-self-center">
                          <strong className="text-(--primary) text-shadow-md text-shadow-black">React: </strong>
                          Front-End framework for UI/UX
                          </Link>
                      </li>
                      <li>
                          <Link href="#" className="p-5 flex flex-col text-center bg-white hover:bg-gray-400/10 rounded-2xl border-b-2 size-full place-self-center">
                          <strong className="text-(--primary) text-shadow-md text-shadow-black">Next.JS: </strong>
                          Framework that adds on to React for various features
                          </Link>
                      </li>
                      <li>
                          <Link href="#" className="p-5 flex flex-col text-center bg-white hover:bg-gray-400/10 rounded-2xl border-b-2 size-full place-self-center">
                          <strong className="text-(--primary) text-shadow-md text-shadow-black">Express.JS: </strong>
                          Back-end framework for fetching data
                          </Link>
                        </li>
                      <li>
                          <Link href="#" className="p-5 flex flex-col text-center bg-white hover:bg-gray-400/10 rounded-2xl border-b-2 size-full place-self-center">
                          <strong className="text-(--primary) text-shadow-md text-shadow-black">PostgreSQL</strong>
                          Database management for storing data
                          </Link>
                      </li>
                      <li>
                          <Link href="#" className="p-5 flex flex-col text-center bg-white hover:bg-gray-400/10 rounded-2xl border-b-2 size-full place-self-center">
                          <strong className="text-(--primary) text-shadow-md text-shadow-black">TypeScript</strong>
