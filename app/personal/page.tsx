...
export default function Personal(){
    ...
    return(
            <div className="hero-bg flex flex-col gap-20 max-w-full h-full px-4 py-20 sm:px-6 lg:px-8 overflow-y-scroll">
                ...
                <div className="bg-white rounded-2xl p-10 shadow-2xl shadow-slate-700 text-2xl mb-15 md:text-4xl text-center">
